...
float fauxclicky_pressed_note[2] = MUSICAL_NOTE(_F5, .125);
float fauxclicky_released_note[2] = MUSICAL_NOTE(_F5, .125);
float fauxclicky_beep_note[2] = MUSICAL_NOTE(_C5, .125);
